...
module Rondel =
    ...
    val setToStartingPositions: PublishRondelEvent -> SetToStartingPositions
    ...
    val move: PublishRondelEvent -> ChargeNationForRondelMovement -> Move
    ...
    val onInvoicedPaid: PublishRondelEvent -> RondelInvoicePaid -> Result<unit, string>
    ...
    val onInvoicePaymentFailed: PublishRondelEvent -> RondelInvoicePaymentFailed -> Result<unit, string>